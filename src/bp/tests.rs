...
#[test]
fn test_rank_0(){
    let balanced_parenthesis1 = BalancedParentheses::from_binary_represantation(String::from("1110100100"));
    /*
                0
               / \
              1  7
    ...
    */
    assert_eq!(2, balanced_parenthesis1.rank_0(5));
    // what if balanced_parenthesis1.rank_0(25)??

    let balanced_parenthesis2 = BalancedParentheses::from_binary_represantation(String::from("10"));
    assert_eq!(0, balanced_parenthesis2.rank_0(0));
    // what if balanced_parenthesis2.rank_0(6)??

    let balanced_parenthesis3 = BalancedParentheses::from_binary_represantation(String::from(""));
    // what if balanced_parenthesis3.rank_0(30)??
    // what if balanced_parenthesis3.rank_0(0)??

    let balanced_parenthesis4 = BalancedParentheses::from_binary_represantation(String::from("110101010100"));
    /*
                0
            /  / \ \ \
           1  3  5 7 9
    */
    assert_eq!(2, balanced_parenthesis4.rank_0(4));
    assert_eq!(2, balanced_parenthesis4.rank_0(5));
...
fn test_rank_1(){
    ...
    */
    assert_eq!(5, balanced_parenthesis1.rank_1(7));
    assert_eq!(4, balanced_parenthesis1.rank_1(6));
    // what if balanced_parenthesis1.rank_1(25)??

    let balanced_parenthesis2 = BalancedParentheses::from_binary_represantation(String::from("10"));
    assert_eq!(0, balanced_parenthesis2.rank_1(0));
    ...
    /*
           ...
           1  3  5 7 9
    */
    assert_eq!(1, balanced_parenthesis4.rank_1(1));
